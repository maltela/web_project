class UsersController < ApplicationController
  ...
  def register
    ...
    @privkey_dec = {:privkey => Base64.decode64(params[:privkey_user_enc])}
    @user = User.new(:identity => params[:identity], :salt_masterkey => params[:salt_masterkey], :pubkey_user => params[:pubkey_user], :privkey_user_enc => @privkey_dec.first.privkey)
