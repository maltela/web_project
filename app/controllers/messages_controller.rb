class MessagesController < ApplicationController
  ...
  def create
    ...
    #@status_code = {:status_code => 422}#Timeout
      ...
      sig_service = params[:recipient].to_s + params[:inner_envelope][:sender].to_s + params[:inner_envelope][:cipher] + Base64.decode64(params[:inner_envelope][:iv]) + Base64.decode64(params[:inner_envelope][:key_recipient_enc]) + params[:timestamp].to_s
