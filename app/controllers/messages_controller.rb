class MessagesController < ApplicationController
  ...
  def showAll
    ...
    @messages = Message.find_by_sql(['select m.id as message_id, u.identity as recipient, send.identity as identitySender, m.recipient_id,
    ...
    render json: @messages.to_json(only: [:message_id, :identitySender])
  end
  ...
  def showMessage
    ...
    render json:  @json_msg.first.to_json
  ...
  def create
   ...
   # if digest == params[sig_service]
      ...
      @message = Message.new(:cipher => params[:inner_envelope][:cipher], :sig_recipient => params[:inner_envelope][:sig_recipient], :iv => params[:inner_envelope][:iv], :key_recipient_enc => params[:inner_envelope][:key_recipient_enc], :sender_id => @sender.first.user_id, :recipient_id => @recipient.first.user_id)
