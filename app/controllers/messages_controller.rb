class MessagesController < ApplicationController
  ...
  def create
    ...
    #@status_code = {:status_code => 422}#Timeout
      ...
      sig_service = params[:recipient].to_s + params[:inner_envelope][:sender].to_s + Base64.decode64(params[:inner_envelope][:cipher]).to_s + Base64.decode64(params[:inner_envelope][:iv]).to_s + Base64.decode64(params[:inner_envelope][:key_recipient_enc]).to_s + params[:timestamp].to_s
